  ...
  return (
    <html lang="en" className="bg-gray-800">
      <head>
        ...
        <meta
          name="keywords"
          content="mr lee, tcm, chiropractor, acupuncture, boon keng, upper boon keng, ubk, mr lee ubk, kallang, massage, 李先生, 李医师, 中医, 推拿, 新加坡推拿"
        />
        <link rel="canonical" href="https://www.mrlee.sg" />
      </head>
